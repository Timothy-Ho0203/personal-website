export const Home = () => {
  return (
    ...
    >
      ...
      >
        <h1 
          className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 
        ...
        >
          I'm a full-stack developer who is interested in building clean, 
          scalable web applications. My goal is to build solutions that 
