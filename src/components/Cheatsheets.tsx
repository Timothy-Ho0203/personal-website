        ...
        <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-300 rounded shadow-lg">
          <ul className="py-2 text-gray-700">
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
              <a
                href="#about"
                onClick={() => getDownloadLink("ST2334_finals.pdf")}
              >
                ST2334 Finals
              </a>
            </li>
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
              <a
                href="#about"
                onClick={() => getDownloadLink("CS2106_midterms.pdf")}
              >
                CS2106 Midterms
              </a>
            </li>
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
              <a
                href="#about"
                onClick={() => getDownloadLink("CS2106_finals.pdf")}
              >
                CS2106 Finals
              </a>
            </li>
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
              <a
                href="#about"
                onClick={() => getDownloadLink("CS2102_finals.pdf")}
              >
                CS2102 Finals
              </a>
            </li>
